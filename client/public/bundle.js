...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
(_a = document.getElementById('btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { data } = yield _api_index__WEBPACK_IMPORTED_MODULE_0__.test();
    console.log(_api_index__WEBPACK_IMPORTED_MODULE_0__.test());
    console.log(data);
}));
